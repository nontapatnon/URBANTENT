...
for lat, lng, name in zip(df_2['lat'].astype(float), df_2['lng'].astype(float), df_2['name'] + ", " + df_2['type']):
    folium.CircleMarker(
        [lat, lng],
        radius=5,
        color='#fa7202',
...
for lat, lng, name in zip(df_3['lat'].astype(float), df_3['lng'].astype(float), df_3['name'] + ", " + df_3['type']):
    folium.CircleMarker(
        [lat, lng],
        radius=5,
        color='#fad902',
...
for lat, lng, name in zip(df_4['lat'].astype(float), df_4['lng'].astype(float), df_4['name'] + ", " + df_4['type']):
    folium.CircleMarker(
        [lat, lng],
        radius=5,
        color='#02fa49',
...
for lat, lng, name in zip(df_5['lat'].astype(float), df_5['lng'].astype(float), df_5['name'] + ", " + df_5['type']):
    folium.CircleMarker(
        [lat, lng],
        radius=5,
        color='#027afa',
...
for lat, lng, name in zip(df_6['lat'].astype(float), df_6['lng'].astype(float), df_6['name'] + ", " + df_6['type']):
    folium.CircleMarker(
        [lat, lng],
        radius=5,
        color='#9b02fa',
